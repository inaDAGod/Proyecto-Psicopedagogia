  ...
  <div class="modal">
    <div class="modal-content">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="form-group">
          <label for="tipo">Tipo de actividad:</label><br>
...
const submitForm = async () => {
  try {
    ...
    let imagen = props.actividades.actividad_src;
    ...
    if (currentFile.value) {
      ...
      imagen = direc + currentFile.value.name;
    }
    ...
    const response = await fetch('http://localhost:3000/api/actividades_socialUpdate', {
      method: 'POST',
      body: formData,
    });
