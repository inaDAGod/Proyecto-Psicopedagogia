<template>
  <div class="modal" v-show="showForm">
    ...
    <SuccessEdit v-if="showSuccessModal" @onClose="closeSuccessModal" :message="'El docente ha sido actualizada correctamente'" :titulo="'Actualización exitosa'"></SuccessEdit>
