    ...
    <div>
            ...
            <div class="cuadro-formulario">
                <div class="modal-content-home">
                    ...
                    <form @submit.prevent="submitFormNoticia">
                        ...
                        <div class="form-group-home">
                            <label for="descripcionNotiAnadir">Descripción:</label><br>
                            <textarea id="descripcionNotiAnadir" v-model="descripcionNotiAnadir"></textarea>
                        </div>
                        <div class="form-group-home">
        ...
        <table class="container-noticias">
            ...
            <tr v-for="(noticiaRow, rowIndex) in noticiaRows" :key="rowIndex">
                ...
                <div class="acciones-publicacion">
                    <button class="boton-accion" @click="editNoticia(noticia)"><img src="/src/assets/images/edit.png" width="20vh" height="auto"></button>
        ...
        <EditModalActividad v-if="selectedActividad" :actividades="selectedActividad" @close="editActividad('actividad')" />
        <EditModalNoticia v-if="selectedNoticia" :noticias="selectedNoticia" @close="editNoticia(null)" />
...
<script setup>
  ...
  import SuccessModal from '/src/components/SuccessModal.vue';
    ...
    const descripcionNotiAnadir = ref('');
    ...
    const submitFormNoticia = async () => {
      try {
        ...
        noticiaData.append('descripcion', descripcionNotiAnadir.value);
